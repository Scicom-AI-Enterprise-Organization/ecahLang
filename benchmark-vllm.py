...
@click.command()
@click.option('--url', default='http://localhost:7088/v1/completions', help='The inference endpoint URL.')
...
def main(url, model, save, max_tokens, timeout, concurrency_list):
